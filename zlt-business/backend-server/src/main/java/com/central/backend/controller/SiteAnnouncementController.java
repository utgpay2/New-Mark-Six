...
//    public Result<PageResult<SiteAnnouncement>> findAnnouncementList(@ModelAttribute SiteAnnouncementCo params) {
//        PageResult<SiteAnnouncement> noticeList = announcementService.findAnnouncementList(params);
...
//    public Result saveOrUpdate(@RequestBody SiteAnnouncement announcement, @LoginUser SysUser sysUser)  {
//        if (sysUser!=null) {
...
//        // 查询公告是否存在
//        SiteAnnouncement sysNotice = announcementService.selectById(id);
//        if (sysNotice == null) {
...
//    public Result updateEnabled(@Valid @ModelAttribute SiteAnnouncementUpdateCo params, @LoginUser SysUser sysUser) {
//        if (sysUser!=null) {

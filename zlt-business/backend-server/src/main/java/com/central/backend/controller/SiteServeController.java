...
//    })
//    @GetMapping
//    public Result<PageResult<SiteServe>> listPage(@RequestParam Map<String, Object> params,@ApiIgnore @LoginUser SysUser user) {
...
//    @GetMapping("/list")
//    public Result<List<SiteServe>> list(@RequestParam Map<String, Object> params, @ApiIgnore @LoginUser SysUser user) {
...
//        }
//        SiteServe model = kpnSiteServeService.getById(id);
...
//    @PostMapping
//    public Result save(@RequestBody SiteServe kpnSiteServe,@ApiIgnore @LoginUser SysUser user) {

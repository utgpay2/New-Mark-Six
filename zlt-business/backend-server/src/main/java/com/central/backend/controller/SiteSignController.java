...
//
//    @Autowired
//    private ISiteSignService signService;
//
//    @Autowired
...
//    })
//    public Result< List<SiteSign>> findSignList(@RequestParam("siteId") Long siteId) {
//        List<SiteSign> signList = signService.findSignList(siteId);
...
//    public Result saveOrUpdate(@RequestBody List<SiteSign> list, @LoginUser SysUser sysUser) {
//        if (sysUser!=null) {
//            list.forEach(info ->{
//                if (info.getId()==null){
...
//            SiteSign kpnSiteSign = list.get(0);

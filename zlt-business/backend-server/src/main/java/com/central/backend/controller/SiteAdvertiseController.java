...
//import com.central.backend.service.ISiteAdvertiseService;
...
//
//    @Autowired
//    private ISiteAdvertiseService advertiseService;
//
//
...
//    public Result<PageResult<SiteAdvertise>> findAdvertiseList(@ModelAttribute SiteAdvertiseCo params) {
//        PageResult<SiteAdvertise> kpnSiteAdvertiseList = advertiseService.findAdvertiseList(params);
...
//    public Result saveOrUpdateAdvertise(@RequestBody  SiteAdvertise advertise, @LoginUser SysUser sysUser)  {
//        if (sysUser!=null){
...
//    public Result updateEnabledAdvertise(@Valid @ModelAttribute SiteAdvertiseUpdateCo params, @LoginUser SysUser sysUser) {
//        if (sysUser!=null) {

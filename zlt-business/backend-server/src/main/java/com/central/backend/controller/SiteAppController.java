...
//    })
//    @GetMapping
//    public Result<PageResult<SiteApp>> list(@RequestParam Map<String, Object> params,@ApiIgnore @LoginUser SysUser user) {
...
//        }
//        SiteApp model = kpnSiteAppService.getById(id);
...
//    @PostMapping
//    public Result save(@RequestBody SiteApp kpnSiteApp,@ApiIgnore @LoginUser SysUser user) {

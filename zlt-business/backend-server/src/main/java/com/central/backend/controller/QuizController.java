...
public class QuizController {
     ...
     * 列表
     */
    @ApiOperation(value = "商户彩种分类(二类)查询列表")
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "siteCategoryId", value = "商户分类(一类)ID", required = true, dataType = "Integer"),
     ...
     * 新增or更新
     */
    @ApiOperation(value = "新增or更新商户彩种分类(二类)")
     ...
     * 删除
     */
    @ApiOperation(value = "删除商户彩种分类(二类)")

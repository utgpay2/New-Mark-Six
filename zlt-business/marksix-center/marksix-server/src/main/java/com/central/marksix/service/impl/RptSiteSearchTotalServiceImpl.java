...
import com.central.marksix.mapper.RptSiteSearchTotalMapper;
    ...
    public List<KpnSiteSearchVo> getSiteSearchTotal(Long sid) {
        ...
        if (CollectionUtil.isEmpty(siteSearchTotalVos)) {
            ...
            if (CollectionUtil.isNotEmpty(siteSearchTotalVos)) {
                RedisRepository.setExpire(redisKey, siteSearchTotalVos, MarksixConstants.RedisKey.EXPIRE_TIME_30_DAYS);
            }
        }

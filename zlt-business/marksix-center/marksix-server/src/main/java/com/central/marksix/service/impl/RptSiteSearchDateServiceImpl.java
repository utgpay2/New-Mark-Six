...
import com.central.marksix.mapper.RptSiteSearchDateMapper;
    ...
    public List<KpnSiteSearchVo> getSiteSearchWeek(Long sid) {
        ...
        if (CollectionUtil.isEmpty(siteSearchMonthVos)) {
            ...
            if (CollectionUtil.isNotEmpty(kpnSiteSearchMonthVos)) {
                RedisRepository.setExpire(redisKey, kpnSiteSearchMonthVos, MarksixConstants.RedisKey.EXPIRE_TIME_30_DAYS);
            }
        }

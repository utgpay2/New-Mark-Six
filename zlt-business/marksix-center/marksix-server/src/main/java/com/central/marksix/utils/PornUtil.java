...
public class PornUtil {
    ...
    public static List<Long> searchByKeywords(Long sid, String keywords) {
        ...
        List<Long> movieIds = MarksixConstants.LocalCache.LOCAL_MAP_SITE_MOVIE_IDS.get(sid);
        for (Long movieId : movieIds) {
            String[] movieNameArr = MarksixConstants.LocalCache.LOCAL_MAP_MOVIE_NAME.get(movieId);

...
import com.central.marksix.mapper.KpnSiteMapper;
    ...
    public List<KpnSite> getList() {
        ...
        if (CollectionUtil.isEmpty(kpnSites)) {
            ...
            if (CollectionUtil.isNotEmpty(kpnSites)) {
                RedisRepository.setExpire(redisKey, kpnSites, MarksixConstants.RedisKey.EXPIRE_TIME_30_DAYS);
            }
        }
        return kpnSites;
    }
    ...
    public KpnSite getInfoById(Long sid) {
        ...
        if (ObjectUtil.isEmpty(kpnSite)) {
            ...
            if (ObjectUtil.isNotEmpty(kpnSite)) {
                RedisRepository.setExpire(siteKey, kpnSite, MarksixConstants.RedisKey.EXPIRE_TIME_30_DAYS);
            }
        }
        return kpnSite;
    }

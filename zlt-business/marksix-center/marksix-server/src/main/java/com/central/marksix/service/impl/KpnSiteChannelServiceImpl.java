...
import com.central.marksix.mapper.KpnSiteChannelMapper;
...
public class KpnSiteChannelServiceImpl extends SuperServiceImpl<KpnSiteChannelMapper, KpnSiteChannel> implements IKpnSiteChannelService {
    ...
    public List<KpnSiteChannel> getAllChannelsBySiteId(Long sid) {
        //固定频道
//        String stashChannelRedisKey = StrUtil.format(MarksixConstants.RedisKey.SITE_STASH_CHANNEL_KEY, sid);
...
//                RedisRepository.setExpire(stashChannelRedisKey, siteChannels, MarksixConstants.RedisKey.EXPIRE_TIME_30_DAYS);
//            }
//        }
        ...
        //站点自定义频道,无影片不展示
        String redisKey = StrUtil.format(MarksixConstants.RedisKey.KPN_SITE_CHANNEL_MOVIEID_VV, sid, MarksixConstants.Symbol.ASTERISK);
...
//        String userChannelRedisKey = StrUtil.format(MarksixConstants.RedisKey.KPN_SITE_USER_CHANNEL_KEY, uid);
...
//                RedisRepository.setExpire(userChannelRedisKey, memberChannels, MarksixConstants.RedisKey.EXPIRE_TIME_30_DAYS);
//            }
//        }
...
//        RedisRepository.delete(userChannelRedisKey);
    ...
    public void addChannel(Long uid, String username, Long siteId, String siteCode, String siteName, Long channelId) {
        ...
        siteUserChannel.setChannelId(channelId);
        siteUserChannel.setSort(MarksixConstants.Numeric.DEFAULT_SORT_VALUE);

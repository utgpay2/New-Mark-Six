 ...
 */
@Component
public class SingaporeMarkSixLotterySettlementXxlJob {
    private static Logger logger = LoggerFactory.getLogger(SingaporeMarkSixLotterySettlementXxlJob.class);

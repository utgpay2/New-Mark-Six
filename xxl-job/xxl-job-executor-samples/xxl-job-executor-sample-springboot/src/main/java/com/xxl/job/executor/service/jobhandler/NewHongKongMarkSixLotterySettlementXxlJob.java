 ...
 */
@Component
public class NewHongKongMarkSixLotterySettlementXxlJob {
    private static Logger logger = LoggerFactory.getLogger(NewHongKongMarkSixLotterySettlementXxlJob.class);

...
import org.search.action.search.SearchRequest;
import org.search.action.search.SearchResponse;
import org.search.client.RequestOptions;
import org.search.client.RestHighLevelClient;
import org.search.common.text.Text;
import org.search.index.query.QueryBuilder;
import org.search.index.query.QueryBuilders;
import org.search.search.SearchHits;
import org.search.search.builder.SearchSourceBuilder;
import org.search.search.fetch.subphase.highlight.HighlightBuilder;
import org.search.search.fetch.subphase.highlight.HighlightField;
...
public class SearchBuilder {
    ...
    public PageResult<JsonNode> getPage(Integer page, Integer limit) throws IOException {
        ...
        return PageResult.<JsonNode>builder().data(list).count(totalCnt).build();
    }

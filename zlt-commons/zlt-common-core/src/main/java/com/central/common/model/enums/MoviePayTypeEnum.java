...
public enum MoviePayTypeEnum {
    ...
    MoviePayTypeEnum(Integer code, String nameZh, String nameEn, String nameKh) {
        this.code = code;
        this.nameZh = nameZh;
        this.nameEn = nameEn;
        this.nameKh = nameKh;
    ...
    public static Map<Integer, String> getOptions(Boolean needAll) {
        ...
        Stream<MoviePayTypeEnum> stream = Arrays.stream(values());
        if (!needAll) {
